...
def admin():
    ...
    if tk.request.method == 'POST':
        ...
        if len(errors):
            ...
            vars['log'] = organisation_helpers.reconcile_local_organisations(context, source_url, api_key)

    return render('admin/organisations.html', extra_vars=vars)


def register_org_admin_rules(blueprint):
    blueprint.add_url_rule('/ckan-admin/organisations', methods=['GET', 'POST'], view_func=admin)
